                ...
                var newsSwtich = function () {
                    ...
                    $(".news").each(function (index) {
                        if (currNews.responseData.feed.entries[$scope.newsIndex] !== undefined) {
                            ...
                            $($('.news')[$scope.newsIndex]).updateWithText(currNews.responseData.feed.entries[$scope.newsIndex].title, 4000);
                            $($('.news')[$scope.newsIndex]).attr("href", currNews.responseData.feed.entries[$scope.newsIndex].link);
